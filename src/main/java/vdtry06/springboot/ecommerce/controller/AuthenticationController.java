...
public class AuthenticationController {
    ...
    ApiResponse<Void> logout(@PathVariable Long userId,  @RequestBody LogoutRequest request) throws ParseException, JOSEException {
        authenticationService.logout(userId, request);
